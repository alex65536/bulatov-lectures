...
\begin{document}
	...
	\begin{eans}
		...
		замкнутое множество, то из последовательности $\left(\widetilde{x}_n, \overline{x}_n\right)$ можно выбрать 
		сходящуюся подпоследовательность $\left(\widetilde{x}_{n_k}, \overline{x}_{n_k}\right)$ к $(x_0, x_1)\in D^2$. Используя то, что
