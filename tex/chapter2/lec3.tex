...
\begin{proof}
	...
	\end{equation}
	т.~е. для $\delta = \frac1n$ получаем, что \[\exists x\left(\frac1n\right) : \delta = \frac1n 
	\implies d\left(x\left(\frac1n\right),x_0\right)\leq \delta.\]
	При $n \to \infty$ имеем $\delta \to 0$ и $d\left(x\left(\frac1n\right),x_0\right) \to 0$. Отсюда имеем
	$x\left(\frac1n\right) \underset{n \to \infty}{\longrightarrow}x_0$, т.~е.
	последовательность 
	$y_n = x(\frac1n)$~-- последовательность Гейне. Но тогда \[\forall \eps_0 > 0 \quad 
