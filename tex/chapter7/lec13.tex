...
\begin{proof}
	...
	\overline{P} = \left\lbrace y_j \right\rbrace$, 
	 ...
	 \Pi_{ij}$ на составляющие его прямоугольники, 
	 причем различные части могут иметь общими лишь, может быть, граничные точки.
    ...
    \Delta x_i = x_i - x_{i - 1},\ 
 	...
 	то для полученной \underline{специальной} интегральой суммы
 	\begin{equation}
 	\label{lec_13, num_14}
