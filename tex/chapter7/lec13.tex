...
\begin{rems} 
	...
	\begin{enumerate}
		\item  На практике формулы (6) (надо сделать ссылкой), 
...
\begin{exmp}
	Рассмотрим $ I = \iint\limits_{x^2 + y^2 \leq 2x} f \left( x, y \right) dx dy $, где
	для простоты считаем, что $ f \left( x, y \right) $ - непрерывна. Получим
	представление этого 2И через повторные.
