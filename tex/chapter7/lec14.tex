...
\begin{document}
	...
	\begin{proof}
		...
		Отсюда при $\widetilde{d_0} = \diam \widetilde{P_0} \to 0$ для функции $F(x, y) = \sum\limits_{k = 1}^m F_k(x, y)$ имеем: 
		...
		при $d = \diam P \to 0$ получаем $0 \leq \diam \widetilde{P} < d \implies \diam \widetilde{P} 
