...
\begin{document}
	...
	\eqref{lec10.1:12} имеет единственное решение в силу того, что определитель
	...
	\eqref{lec10.1:13} уже дифференциалы
	...
	\]
	Присоединяя к \eqref{lec10.1:14}  и уравнение \eqref{lec10.1:14} по 
	уравн. связи получаем \smallskip систему из \eqref{lec10.1:12}, 
	\eqref{lec10.1:14},
	\eqref{lec10.1:15} из $ \left( n + 2m \right) $ уравнений:
	...
	функции Лангранжа \eqref{lec10.1:8}, где все переменные равноправны.
	...
	знакоопр. При этом в силу специфики функции Лагранжа \eqref{lec10.1:8} 
	...
	соответствии с \eqref{lec10.1:8} 
	имеем 
