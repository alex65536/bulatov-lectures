...
(\emph{Примечание редактора:} здесь Булатов, судя по всему, предполагает выполнение этого равенства, а не утверждает, что оно всегда верно (чего он, естественно, не доказывает)). 
