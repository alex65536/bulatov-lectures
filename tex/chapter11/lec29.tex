...
\begin{document}
	...
	\end{equation}
	\begin{definition}
		Если \eqref{29:2} сходится, то говорят, что ряд \eqref{29:1} \emph{сходится 
		абсолютно}.
	\end{definition}
...
\end{remark}
	...
	\begin{example}
		...
		т.~е. выполнены все условия \href{29:leibnitz}{признака Лейбница}. Значит, 
		ряд сходится.
...
\begin{definition}
	...
	\eqref{29:1} сходится \emph{условно}.
\end{definition}
	...
	\end{thm}
	\begin{proof}
		\encircle{$\implies$} Пусть ряд $\sum\limits_{k = 1}^\infty |a_k|$ 
		сходится. 
