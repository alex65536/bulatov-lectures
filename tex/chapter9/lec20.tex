...
\begin{proof}
	...
	\begin{itemize}
		...
		\begin{gathered}
			...
			P(x, \phi(x)) \right)\,dx = \\
			= \int\limits_{a}^{b} P(x, \phi(x))\,dx + 
			\int\limits_{b}^{a} P(x, \psi(x))\,dx = 
