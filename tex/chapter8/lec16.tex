...
\begin{equation}
\label{lec16:6}
S \overset{\eqref{lec16:2}}{=} \iint\limits_G \abs{ I(u,v)} dudv.
\end{equation}
...
\begin{example}
	...
	(x,y)\in G \subset \R^2,
	\end{equation*}
	учитывая, что якобиан $I=r$, для площади имеем 
	\begin{equation}
	\label{lec16:7}
...
\begin{exercise}
	...
	якобиан $I=\alpha a b r \cos^{\alpha-1}\phi\sin^{\alpha-1}\phi$ и, значит, 
	для 
	площади имеем
	\begin{equation}
	\label{lec16:8}
...
\begin{equation}
\label{lec16:13}
V = \text{объём } T = \iiint\limits_Tdxdydz=\iiint\limits_G \abs{I(u, v, 
\omega)}dudv d\omega.
\end{equation}
