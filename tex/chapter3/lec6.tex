...
\begin{document}
	\begin{exmp}
		...
		Отсюда, в частности, в виду инвариантности формулы первого 
		...
		вычисляют $f'_s$, $f'_t$ и потом подставляют 
		$t = xyz$, $s = x + y + z$.
	\end{exmp}
	...
	\begin{exmp}
		...
		\[u'_y = \left[\begin{aligned}
			& x\ \text{фиксировано}\\
			& z\ \text{фиксировано}
		\end{aligned}\right] = x^{y^z}\ln x\cdot z\cdot y^{z-1},\]
		...
		\begin{gather*}
			u''_{zx} = \left(u'_z\right)'_x =
			 ...
			 = y^zx^{y^z - 1}y^z\ln y\ln x + x^{y^z - 1}y^z\ln y.
		\end{gather*}
	...
	\begin{proof}
		...
		Для ффиксированных допустимых $\D y$ для функции $g(t)=f(t, b + \D y) - 
		f(t, b)$
		...
		f''_{xy}\left(a + \Theta_1\D x, b + \Theta_2\D y\right)\D y\implies\]
		\begin{equation}
		...
		\begin{equation}
			...
			\D y\rightarrow 0}}{\overset{\Theta_1,\Theta_2\ 
			\text{огран.}}{\longrightarrow}} M_0\left(a, b\right)
			\label{17:diff}
		\end{equation}
		...
		\begin{equation}
			...
			\underset{\substack{\D x\rightarrow 0\\
			\D y\rightarrow 0}}{\overset{\Theta_3,\Theta_4\ 
			\text{огран.}}{\longrightarrow}} M_0\left(a, b\right)
			\label{19:diff}
		\end{equation}
	...
	\begin{remark}
		...
		f''_{xyx}\left(M_0\right)\ \text{и т.д.}\]
	\end{remark}
